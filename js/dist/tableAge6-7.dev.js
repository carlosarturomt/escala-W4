...
function calculateSumScores() {
  ...
  if (calculateYear() == '6,0' || calculateYear() == '6,1' || calculateYear() == '6,2' || calculateYear() == '6,3') {
    ...
    switch (valueinputDC) {
      case '55':
        var punctuationDC_0 = document.getElementById("punctuationDC_0");
        punctuationDC_0.innerText = 10;
        var punctuationDC_1 = document.getElementById("punctuationDC_1");
        punctuationDC_1.innerText = 10;
        var punctuationDC_2 = document.getElementById("punctuationDC_2");
